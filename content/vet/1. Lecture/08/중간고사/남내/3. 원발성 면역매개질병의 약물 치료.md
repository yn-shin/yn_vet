...
- 스테로이드는 부작용이 흔하지만 쉽게 해소되는 반면, azathioprine에서는 부작용이 흔하지 않지만 <u>생기면 심각한 편</u>.
...
- **IMHA, ITP**에 널리 사용됨.
	- 재발성 MG(myasthenia gravis), nflammatory bowel disease, MUE(뇌수막염meningoencephalomyelitis of unknown etiology)에도 사용.
...
- 쓸개, 비장은 둘 중 하나는 적출해도 괜찮음. 혈구 탐식 장기 자체를 제거 → 
