...
- 신체 검사 : systolic heart murmur(심잡음), pyrexia(열), tachycardia(빈맥), tachypnea(빈호흡), pallor(창백함), icterus(황달), splenomegaly(비장종대), hepatomegaly(간종대), abdominal pain(복부 통증) 등
