...
- 대사성 acidosis → 호흡성으로 akalysis를 다시 만들어내며 balance를 맞추려고 함. 그래서 중탄산염 치료 시 정맥으로 10-15분에 걸쳐 1/2을 투여하고 재측정, 필요 시 나터미 용량을 4-6시간에 거쳐 투여. 몸이 계속 balance를 맞추기 때문에, 측정을 기초로 추가투여가 필요할 때만 반복.
...
- 기흉을 일으키는 4가지 액체 성분 : 피(혈흉, hemothorax) / 농흉(pyothorax, 고양이 다발) / 유미흉(chylothorax, 임파액 유출) / 물(hydrothorax)
...
- 정맥내 수액
- vital sign check
- hypothermic patients : 체온조절중추도 망가진
