...
| --------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [[22-03. Blackleg\|22-03. Blackleg]]                                                                                   | ==C. chauvoei==<br>gas 괴저균                                                                                   | by **Histotoxic Clostridia**
...
- endogenous 감염 (주로 oral route)<br>- 근육에서 샘플 → 도말 표본으로 원인체 확인
- 형광 항체법(균 동정)
...
- 소에서 나타나며, 기종저와 증상 유사
- 기종저에 비해 숙주가 넓고(모든 연령대), 산발적 발생<br>- CAMP test 양성, plate neutralization test(배지 분해O)
- 도말 표본을 제작하여 균 동정
...
- 식욕 부진, depression, 열 등의 증상을 보이기도 함<br>- 제4위에서 심한 형태의 충출혈 소견                                                                                                                                                                     | - 주로 겨울철 발생, 겨울에 언 먹이나 목초 먹으면 차가운 먹이가 잘 소화되지 않아 제4위의 기능 저하<br>- 형광 항체로 검출                                                                                                                                                                     |
...
- 기생충과 혼합 감염 시 -> 균의 endospore germination을 유발하여 간 조직을 심하게 파괴함<br>- 간 병변으로부터 균을 검출하여 형광 항체로 진단                                                                                                                   |
...
- 혈액의 RBC를 심하게 파괴하여 hemoglobinuria를 유발 (β-toxin의 작용)                                                                                                                                           | - 주로 소에서 발생하지만, 양에서도 발생함<br>- 간 병변에서 균을 검출하여 형광 항체로 진단                                                                                                                                                                                        |
...
- 성숙한 양에서 감염 (주로 영양분 많은 사료의 과식 때문)<br>- 항문 주위, 꼬리, 뒷다리에 묻은 변을 보고 진단 가능                                                                                                                                                  |
...
- 사료가 장에 축적 → 균 증식하기 적합한 환경, 증식하며 독소 생성<br>\-                                                                                                                                                                            |
...
- 혈변 나타나면 폐사율 100%<br>- 백신 접종, [[penicillin|penicillin]] 계 및 [[macrolide|macrolide]] 계 경구 투여                                                                                                |
